...
<meta name="mobile-web-app-capable" content="yes">
     ...
     <script type="text/javascript" src="${basePath}Js/artDialog/plugins/iframeTools.js"></script>
...
<body>
<form class="form-inline definewidth m20" id="myform" action="LiveMediaAction.do?method=live_list" method="post">    
    ...
    <script type="text/javascript">
        BUI.use(['bui/grid','bui/data'],function(Grid,Data){
          ...
          columns = [
            ...
            {title : '直播标题',dataIndex :'title', width:100},
            {title : '直播标签',dataIndex :'tag', width:100},
            {title : '直播描述',dataIndex : 'description',width:100},
            {title : '地理位置',dataIndex : 'location',width:100},
            {title : '类型',dataIndex : 'type',width:100},
            {title : 'roomId',dataIndex : 'roomId',width:250,renderer : function(value,obj){
              return '<a  href="#" class="grid-command btn-del" onClick="show_live('+obj.id+')"><i class="icon"></i> '+obj.roomId+'</a>'}
            },
            {title : '直播时间',dataIndex : 'start_time',width:200},
            {title : '图片',dataIndex : 'frame',width:100,renderer : function(value,obj){
              return '<a  href="#" class="grid-command btn-del" onClick="show_img('+obj.id+')"><i class="icon"></i> 预览</a>'
            	}
            },
...
$("#time option[value='"+time_val+"']").attr("selected",true);


		$('#addnew').click(function(){

				window.location.href="LiveMediaAction.do?method=addUI";
		 });
	...
	{
art.dialog.open('LiveMediaAction?method=showImg',
{
    title: '预览图片',
    width: 600,
    height: 440,
