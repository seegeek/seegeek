...
<div class="demo-content">
  ...
  <script src="http://g.alicdn.com/bui/bui/1.1.21/config.js"></script>
    <script type="text/javascript">
        BUI.use(['bui/grid','bui/data'],function(Grid,Data){
          ...
          columns = [
            ...
            {title : '操作',width : 100,dataIndex:'e',renderer : function(value,obj){
              return '<a  href="RoleAction.do?method=editUI&id='+obj.id +'" class="grid-command btn-edit"><i class="icon icon-edit"></i> 修改</a><a  href="RoleAction.do?method=setPrivilegeUI&id='+obj.id +'" class="grid-command btn-del"><i class="icon icon-tag"></i> 设置权限</a><a  href="RoleAction.do?method=delete&id='+obj.id +'" onClick="del()" class="grid-command btn-del"><i class="icon icon-trash"></i> 删除</a>'
            }
            }
          ];
         ...
         */
        var store = new Store({
            url : 'RoleAction.do?method=list_json',
        ...
        $('#addnew').click(function(){
				...
				window.location.href="RoleAction.do?method=addUI";
		 });
		$('#search').click(function(){
				var username=$("#username").val();
				window.location.href="RoleAction.do?method=list&name="+username;
		 });
