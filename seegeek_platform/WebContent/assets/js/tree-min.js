...
/**
 * @fileOverview u9009u62e9u6846u547du540du7a7au95f4u5165u53e3u6587u4ef6
 * @ignore
 */
define("bui/tree", ["bui/common", "bui/tree/treemixin", "bui/tree/treelist"], function (e) {
	...
	var n = e("bui/common"), r = e("bui/data"), i = "expanded", s = "loading", o = "checked", u = "partial-checked", a = {NONE:"none", ALL:"all", CUSTOM:"custom", ONLY_LEAF:"onlyLeaf"}, f = "x-tree-icon", l = "x-tree-elbow", c = "x-tree-show-line", h = l + "-", p = f + "-wraper", d = h + "line", v = h + "end", m = h + "empty", g = h + "expander", y = f + "-checkbox", b = g + "-end", w = function () {
	};
	return w.ATTRS = {store:{getter:function (e) {
		if (!e) {
			var t = this, n = new r.TreeStore({root:t.get("root"), data:t.get("nodes")});
			return t.setInternal("store", n), n;
		}
		return e;
	}}, root:{}, nodes:{sync:!1}, iconContainer:{}, iconWraperTpl:{value:"<span class=\"" + p + "\">{icons}</span>"}, showLine:{value:!1}, iconTpl:{value:"<span class=\"x-tree-icon {cls}\"></span>"}, leafCls:{value:h + "leaf"}, dirCls:{value:h + "dir"}, checkType:{value:"custom"}, checkedField:{valueFn:function () {
		return this.getStatusField("checked");
	}}, itemStatusFields:{value:{expanded:"expanded", disabled:"disabled", checked:"checked"}}, dirSelectable:{value:!0}, showRoot:{value:!1}, events:{value:{expanded:!1, collapsed:!1, checkchange:!1}}, startLevel:{value:1}}, n.augment(w, {collapseAll:function () {
		...
		if (s.isChecked(e) !== r || s.hasStatus(e, "checked") !== r) {
			a = s.findElement(e), a ? (s.setItemStatus(e, o, r, a), s._resetPatialChecked(e, r, r, a)) : s.isItemDisabled(e) || s.setStatusValue(e, "checked", r), u && (s.isChecked(u) != r ? s._resetParentChecked(u) : s._resetPatialChecked(u, null, null, null, !0)), s.fire("checkchange", {node:e, element:a, checked:r});
		}
		...
		r.hasStatus(e, i, t) && (r.setItemStatus(e, i, !1, t), n ? (r._collapseChildren(e, n), r.removeItems(e.children)) : r._hideChildrenNodes(e), r.fire("collapsed", {node:e, element:t}));
		...
		s.hasStatus(e, i, t) || (o && !o.isLoaded(e) ? s._isLoading(e, t) || o.loadNode(e) : t && (s.setItemStatus(e, i, !0, t), s._showChildren(e), s.fire("expanded", {node:e, element:t}))), n.each(e.children, function (e) {
		...
		for (s = r - 1; s >= 0; s--) {
			i = e.children[s], t.getItem(i) || t.addItemAt(i, n + 1);
		}
	...
	var t = e("bui/common"), n = e("bui/list"), r = e("bui/tree/treemixin"), i = n.SimpleList.extend([r], {}, {ATTRS:{itemCls:{value:t.prefix + "tree-item"}, itemTpl:{value:"<li>{text}</li>"}, idField:{value:"id"}}}, {xclass:"tree-list"});
	return i;
});
