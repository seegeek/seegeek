...
function doHTML5(url){
	...
	document.write('<div class="video_control"  id="p_player">');
		document.write('<button onclick="v.play()">Play</button>');
  		document.write('<button onclick="v.pause()">Pause</button>');
  		document.write('<button onclick="v.volume+=0.1">Volume Up</button>');
  		document.write('<button onclick="v.volume-=0.1">Volume Down</button>');
	document.write('</div>');	      
}	      
